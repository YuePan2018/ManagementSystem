...
<title>Management System Index</title>
...
<body class="easyui-layout">
    	...
    	<div class="easyui-accordion" data-options="border:false,fit:true"> 
            ...
            <div title="系统设置" data-options="iconCls:'icon-wrench'" style="padding:5px;">  	
    			<ul class="easyui-tree wu-side-tree">
                	...
                	<li iconCls="icon-chart-organisation"><a href="javascript:void(0)" data-icon="icon-chart-organisation" data-link="../admin/role/list" iframe="0">角色管理</a></li>
                </ul>
            </div>
        </div>
    </div>	
    ...
    <div class="wu-main" data-options="region:'center'">
        <div id="wu-tabs" class="easyui-tabs" data-options="border:false,fit:true">  
            <div title="Welcome Page" data-options="href:'welcome',closable:false,iconCls:'icon-tip',cls:'pd3'"></div>
        </div>
    </div>
    <!-- end of main --> 
    <!-- begin of footer -->
